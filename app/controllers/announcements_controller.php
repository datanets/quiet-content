...
class AnnouncementsController extends AppController {
            ...
            if (empty($this->data)) {
                        ...
                        if ( isset($v['name']['tmp_name']) ) {
                            if ( isset($v['name']['name']) && $v['name']['name'] > '') {
                                ...
                                if (move_uploaded_file($v['name']['tmp_name'], $announcement_attachments_base_dir . $v['name']['name'])) {
                                    //$this->Announcement->resize_image($announcement_attachments_base_dir . $v['name']['name'], $resize_image_width, $resize_image_height);
                ...
                if (isset($_FILES['data']['name']['Announcement']['enclosure']) && $_FILES['data']['name']['Announcement']['enclosure'] > '') {
                    ...
                    if (move_uploaded_file($_FILES['data']['tmp_name']['Announcement']['enclosure'], $enclosures_base_dir . $_FILES['data']['name']['Announcement']['enclosure'])) {
                        ...
                        //$this->Announcement->resize_image($enclosures_base_dir . $_FILES['data']['name']['Announcement']['enclosure'], $resize_image_width, $resize_image_height);
                ...
                if ($this->Announcement->saveAll($this->data)) {
                    ...
                    $items = $this->Announcement->find('all', array('order' => 'Announcement.modified DESC', 'limit' => '10', 'conditions' => array('status_id' => '1')));
    ...
    function view($id = null) {
        ...
        $announcement = $this->Announcement->find('first', array('conditions' => array('Announcement.id' => $id, 'Announcement.status_id' => '1')));
        ...
        $categories = $this->Announcement->AnnouncementCategory->find('threaded', array( 'conditions' => array(
        ...
        $users_array = $this->Announcement->User->find('all', array('fields' => array('id', 'username', 'first_name', 'email')));
        $users = array();
    ...
    function remove($id = null) {
        ...
        if ($user['usertype'] <= 2) {
            ...
            if (isset($_POST) && $_POST) {
                ...
                $items = $this->Announcement->find('all', array('order' => 'Announcement.modified DESC', 'limit' => '10'));
    ...
    function feed() {
        ...
        if( $this->RequestHandler->isRss() ){
            ...
            $this->Announcement->contain();
            $this->set('posts', $this->Announcement->find('all', array( 'order' => 'Announcement.modified DESC',
                                                                        'limit' => 10,
