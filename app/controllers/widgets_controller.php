...
class WidgetsController extends AppController {
    ...
    function index() {
        ...
        if ($user['usertype'] <= 2) {
            ...
            $this->Widget->contain();
            $this->set('widgets', $this->Widget->find('all', array('order' => 'id')));
    ...
    function create() {
        ...
        if ($user['usertype'] <= 2) {
            ...
            $dummy_item_add_label =  '<li class="menu_label" style="background-color:#aaa;">'
                                    ...
                                    .'<label>Label</label>'
                                    .'<input type="text" id="WidgetItem0Title" name="data[WidgetItem][0][title]" value="" />'
                                    .'<input type="hidden" id="WidgetItem0ItemType" name="data[WidgetItem][0][item_type]" value="1" />'
                                    .'<div class="weight_box">'
                                    .'<input type="hidden" id="WidgetItem0Weight" name="data[WidgetItem][0][weight]" value="1" />'
                                    .'</div>'
                                    .'</div>'
                                    .'</li>';
            ...
            $dummy_item_add_link =   '<li class="menu_label">'
                                    ...
                                    .'<div style="padding:10px;padding-top:0;">'
                                    .'<input type="hidden" id="WidgetItem0ItemType" name="data[WidgetItem][0][item_type]" value="2" />'
                                    .'<div class="weight_box">'
                                    .'<input type="hidden" id="WidgetItem0Weight" name="data[WidgetItem][0][weight]" value="1" />'
                                    .'</div>'
                                    ...
                                    .'<label>Link Text</label><input type="text" id="WidgetItem0OtherLinkText" name="data[WidgetItem][0][other_link_text]" value="" style="width:300px;" />'
                                    .'<label>Link Address</label><input type="text" id="WidgetItem0OtherLink" name="data[WidgetItem][0][other_link]" value="" style="width:300px;" />'
                                    .'</div>'
                                    .'</div>'
                                    .'</li>';
                ...
                foreach ($this->data['Widget'] as $key => $value) {
                    if ($value == 1) {
                        ...
                        if ($this->Widget->delete($delete_this, false)) {
                            ...
                            //$this->Widget->query("delete from widget_items where widget_id = $delete_this");
