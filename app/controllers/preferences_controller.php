...
class PreferencesController extends AppController {
    ...
    function list_all() {
        return $this->Preference->find('list', array('fields' => array('Preference.name'),
    ...
    function index() {
        ...
        if ($user['usertype'] <= 3) {
            ...
            //$this->set('preferences', $this->Preference->find('all'));
...
/*
        ...
        if ($user['usertype'] == 1) {
            ...
            $this->set('title_for_layout', 'Preferences : Edit');
            

            if (empty($this->data)) {

                //$this->data = $this->Preference->read();
...
exit;
                //if ($this->Preference->saveAll($this->data)) {
                    ...
                    $this->Session->setFlash('Your preference has been updated.');
