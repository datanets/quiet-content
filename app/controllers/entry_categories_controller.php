...
class EntryCategoriesController extends AppController
{
        ...
        if ($user['usertype'] <= 2) {
            ...
            if (empty($this->data)) {
                $this->data = $this->EntryCategory->find('first',
                    array(
                        'contain' => array(
                            'EntryCategoryMenuItem' => array('order' => 'weight'),
                            'EntryCategoryWidget'
                        ),
                ...
                $category_entry_list = $this->EntryCategory->find('all',
                    array(
                        'contain' => array('Entry.id', 'Entry.subject'),
                        'conditions' => array(
    ...
    function view($id = null)
    {
        ...
        $parent_item = $this->EntryCategory->find('first',
            array('conditions' => array('EntryCategory.id' => $id))
        );
        $categories = $this->EntryCategory->find('threaded',
            array(
                'conditions' => array(
        ...
        $just_categories = $this->EntryCategory->find('all',
            array(
                'conditions' => array(
                    'EntryCategory.lft >=' => $parent_item['EntryCategory']['lft'],
                    'EntryCategory.rght <=' => $parent_item['EntryCategory']['rght']
        ...
        $featured = $this->EntryCategory->Entry->find('all',
            array(
                'conditions' => array(
