...
class EmergencyAlertsController extends AppController {
    ...
    //var $uses = array('EmergencyAlert', 'EmergencyAlertCategory', 'Status');
    ...
    function index() {
        ...
        if ($user['usertype'] <= 1) {
            ...
            $this->set('emergency_alerts', $this->EmergencyAlert->find('all', array('order' => 'EmergencyAlert.modified DESC')));
        ...
        if ($user['usertype'] <= 1) {
            ...
            if (empty($this->data)) {
                ...
                if ($this->EmergencyAlert->saveAll($this->data)) {
                    ...
                    $items = $this->EmergencyAlert->find('all', array('order' => 'EmergencyAlert.modified DESC', 'limit' => '10', 'conditions' => array('status_id' => '1')));
    ...
    function view($id = null) {
        ...
        $entry = $this->EmergencyAlert->find('first', array('conditions' => array('EmergencyAlert.id' => $id, 'EmergencyAlert.status_id' => '1')));
        ...
        $categories = $this->EmergencyAlertCategory->find('threaded', array( 'conditions' => array(
        ...
        $users_array = $this->EmergencyAlert->User->find('all', array('fields' => array('id', 'username', 'first_name', 'email')));
        $users = array();
    ...
    function remove($id = null) {
        ...
        if ($user['usertype'] <= 1) {
            ...
            if (isset($_POST) && $_POST) {
                ...
                $items = $this->EmergencyAlert->find('all', array('order' => 'EmergencyAlert.modified DESC', 'limit' => '10'));
    ...
    function feed() {
        ...
        if( $this->RequestHandler->isRss() ){
            ...
            $this->EmergencyAlert->contain();
            $this->set('posts', $this->EmergencyAlert->find('all', array(   'order' => 'EmergencyAlert.modified DESC',
                                                                            'limit' => 10,
                                                                            'conditions' => array('EmergencyAlert.status_id' => '1'))));
        }
    ...
    function dummy_item_image() {
        ...
        $o = '<li class="ui-state-default record" id="img_0">'
            ...
            .'<input type="file" name="data[EmergencyAlertImage][0][name]" value="" id="EmergencyAlertImage0Name" /'
            .'<input type="hidden" name="data[EmergencyAlertImage][0][entry_id]" value="' . $this->EmergencyAlert->id . '" id="EmergencyAlertImage0EmergencyAlertId" /'
            .'<div class="weight_box"><input type="hidden" name="data[EmergencyAlertImage][0][weight]" value="1" id="EmergencyAlertImage0Weight" /></div>'
            .'</li>';
    ...
    function dummy_item_attachment() {
        ...
        $o = '<li class="ui-state-default record" id="atm_0">'
            ...
            .'<input type="file" name="data[EmergencyAlertAttachment][0][name]" value="" id="EmergencyAlertAttachment0Name" /'
            .'<input type="hidden" name="data[EmergencyAlertAttachment][0][entry_id]" value="' . $this->EmergencyAlert->id . '" id="EmergencyAlertAttachment0EmergencyAlertId" /'
            .'<div class="weight_box"><input type="hidden" name="data[EmergencyAlertAttachment][0][weight]" value="1" id="EmergencyAlertAttachment0Weight" /></div>'
            .'</li>';
