...
/*
    var $hasOne = array('AdCategoryType' => array( 'foreignKey' => 'id',
                                            'type' => 'LEFT',
                                            'fields' => ' ' ),
                        'AdCategoryWidget' => array( 'foreignKey' => 'id',
                                            'type' => 'LEFT',
                                            'fields' => ' ' )
                        );
*/

    var $hasMany = array('Ad' => array( 'foreignKey' => 'ad_category_id',
                                                  'type' => 'INNER',
                                                  'order' => 'Ad.subject',
                                                  'conditions' => array('Ad.status_id' => '1') ));
/*
                         'AdCategoryMenuItem' => array( 'foreignKey' => 'category_menu_id',
                                                  'type' => 'LEFT',
                                                  'order' => 'AdCategoryMenuItem.weight' )
...
*/
    ...
    function list_nav_categories() {
        ...
        //$category_menu_ads_string = implode(',', $category_menu_ads_list);

        $ads = $this->Ad->find('all', array( 'conditions' => array(  'Ad.id' => $category_menu_ads_list,
                                                                            'Ad.status_id' => '1'),
