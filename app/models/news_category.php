...
/*
    var $hasOne = array('NewsCategoryType' => array( 'foreignKey' => 'id',
                                            'type' => 'LEFT',
                                            'fields' => ' ' ),
                        'NewsCategoryWidget' => array( 'foreignKey' => 'id',
                                            'type' => 'LEFT',
                                            'fields' => ' ' )
                        );
*/

    var $hasMany = array('News' => array( 'foreignKey' => 'news_category_id',
                                                  'type' => 'INNER',
                                                  'order' => 'News.subject',
                                                  'conditions' => array('News.status_id' => '1') ));
/*
                         'NewsCategoryMenuItem' => array( 'foreignKey' => 'category_menu_id',
                                                  'type' => 'LEFT',
                                                  'order' => 'NewsCategoryMenuItem.weight' )
...
*/
    ...
    function list_nav_categories() {
        ...
        $main_result_array = $this->find('all', array('conditions' => array('parent_id' => $category_root_id), 'order' => 'lft',
                                        'contain' => array('NewsCategoryMenuItem')));
        ...
        //$category_menu_news_string = implode(',', $category_menu_news_list);

        $news = $this->News->find('all', array( 'conditions' => array(  'News.id' => $category_menu_news_list,
                                                                            'News.status_id' => '1'),
