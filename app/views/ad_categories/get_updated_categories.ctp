    ...
    function list_children($item, $site_base_url = null) {
        ...
        if (isset($item['children']) && $item['children']) {
            ...
            <li id="item_<?php echo $item['children'][$i]['AdCategory']['id']; ?>"><?php
                ...
                echo '<div class="category_options"><a href="ad_categories#rename" class="rename_category">Rename</a> | <a href="' . $site_base_url . 'en
try_categories/delete/' . $item['children'][$i]['AdCategory']['id'] . '" class="delete_category">Delete</a></div>';
