...
<div class="actions">
    <ul>
        ...
        <li><a href="<?php echo $site_base_url ?>announcements/edit/<?php echo $announcement['id'] ?>">Edit Announcement</a> </li>
        <li><a href="<?php echo $site_base_url ?>announcements/remove/<?php echo $announcement['id'] ?>" onclick="return confirm(&#039;Are you sure you want to delete this announcement?&#039;);">Delete Announcement</a> </li>
