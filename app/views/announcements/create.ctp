...
<h1><?php echo $html->link('Announcements', '/announcements'); ?> &rsaquo; New</h1>
...
<?php
    ...
    echo '<div class="list_field"><input name="data[Announcement][created]" type="text" maxlength="255" value="' . $date_created . '" id="AnnouncementCreated" class="date-selection" /></div></li>';
    ...
    echo '<li><div class="list_label">Status</div><div class="list_field">' . $form->input('Announcement.status_id', array('label' => false, 'selected' => '1')) . '</div></li>';
    ...
    echo '<div class="list_field">' . $form->checkbox('Announcement.no_splash_image', array('checked' => 'checked')) . 'No Splash Image</div></li>';
    echo '<li><div class="list_label">Podcast</div><div class="list_field">';
    echo '&nbsp;';
    echo $form->file('Announcement.enclosure');
    echo '</div></li>';
    echo '<li><div class="list_label">&nbsp;</div>';
    echo '<div class="list_field_checkbox">' . $form->checkbox('Announcement.no_enclosure', array('checked' => 'checked')) . 'No Podcast</div></li>';
