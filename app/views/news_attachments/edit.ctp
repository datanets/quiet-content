...
<?php echo $this->Form->create('NewsAttachment');?>
	<fieldset>
 		<legend><?php __('Edit News Attachment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('NewsAttachment.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('NewsAttachment.id'))); ?></li>
